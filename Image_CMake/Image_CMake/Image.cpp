...
void Image::create(int rows, int cols, int channels) {
	Image image = { Image_rows = rows, Image_cols = cols, Image_channels = channels };
}
...
Image Image::col(int x) {
	Image Image = { Image_rows = 1,Image_cols = x,Image_channels = Image_channels };
...
Image Image::row(int y) {
	Image Image = { Image_rows = y,Image_cols = 1,Image_channels = Image_channels };
